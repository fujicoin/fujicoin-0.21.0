...
All:
 ...
 `./gitian-build.py --detach-sign --no-commit -b satoshi v0.21.0`

Linux:

 `./gitian-build.py --detach-sign --no-commit -b -o l satoshi v0.21.0`

Windows:

 `./gitian-build.py --detach-sign --no-commit -b -o w satoshi v0.21.0`

OSX:

 `./gitian-build.py --detach-sign --no-commit -b -o m satoshi v0.21.0`
